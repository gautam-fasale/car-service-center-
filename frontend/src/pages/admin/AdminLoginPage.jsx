...
export const AdminLoginPage = () => {
  ...
  const handleQuickDemo = async () => {
    try {
      ...
      setError('Failed admin demo login');
    }
  };
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight">CarServ Admin</h2>
          <p className="text-xs text-slate-400 mt-1">Welcome Back! Login to your admin account</p>
        </div>
        ...
        <div className="mt-6 pt-4 border-t border-slate-800 text-center">
          <button
            ...
            type="button"
            className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-emerald-400 font-bold rounded-xl text-xs flex items-center justify-center gap-2 transition"
          >
            <ShieldCheck className="w-4 h-4" /> 1-Click Master Admin Demo
          </button>
